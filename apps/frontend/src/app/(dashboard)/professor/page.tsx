          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            <Card>
              ...
              <CardContent>
                ...
                <Link href="/professor/courses" className="text-xs text-primary-600 hover:underline">
                  View all courses
                </Link>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="text-xs text-gray-500">{stats.activeStudents} active this week</div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <Link href="/professor/submissions" className="text-xs text-primary-600 hover:underline">
                  Review submissions
                </Link>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <Link href="/professor/questions" className="text-xs text-primary-600 hover:underline">
                  Answer questions
                </Link>
              </CardContent>
            </Card>
                    ...
                    <div key={activity.id} className="flex items-start gap-4">
                      ...
                      <div className="flex-1 space-y-1">
                        <p className="text-sm font-medium leading-none">
                          ...
                          {activity.type === 'question' && ' asked about '}
                      ...
                      {(activity.type === 'submission' || activity.type === 'question') && (
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="space-y-2">
                    <div className="flex justify-between items-center">
                      <div className="font-medium">Introduction to Machine Learning</div>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-center">
                      <div className="font-medium">Web Development with React</div>
